      ...
      <form method="POST" target="_blank" action="{{ route('reportevts.store') }}">
        ...
        <div class="row mb-4 px-4 d-flex justify-content-center">
          <div class="form-check form-switch">
            <label class="form-check-label" for="flexSwitchCheckDefault">Ver Vista en el Navegador</label>
            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="vista">
          </div>
        </div>
        <div class="row">
          @for ($i=$fini; $i < $ffin; $i=strtotime(date('d-m-Y',$i) .'+1 month')) <div class="col-3 mb-2">

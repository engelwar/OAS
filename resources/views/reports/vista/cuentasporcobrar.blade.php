    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-12">
            ...
            <tfoot class="table tabll-sm border">
                ...
                <th>TOTAL</th>
                <td class="sumTCXC"></td>
                <td class="sumTCuenta"></td>
                <td class="sumTSaldo"></td>
                <th colspan = 7></th>
                <!--/tr>
                <tr class="text-right">
                <td colspan = 3></td>
                ...
                <td colspan = 3></td>
                <td>VIGENTE</td>
                <td class="sumVigenteCXC"></td>            
                <td class="sumVigenteCuenta"></td>
                <td class="sumVigenteSaldo"></td>
                <td colspan = 8></td>
                </tr>
                <tr class="text-right">
                <td colspan = 3></td>
                <td>VENCIDO</td>
                <td class="sumVencidoCXC"></td>            
                <td class="sumVencidoCuenta"></td>
                <td class="sumVencidoSaldo"></td>
                <td colspan = 8></td>
                </tr>
                <tr class="text-right">
                <td colspan = 3></td>
                <td>MORA</td>
                <td class="sumMoraCXC"></td>            
                <td class="sumMoraCuenta"></td>
                <td class="sumMoraSaldo"></td>
                <td colspan = 8></td>
            </tr>
            </tfoot>
            </table>        
...
{  
    ...
    function totales() 
    {
        ...
        //console.log(tab); 
        var sumTCXC = table.column( 4, {search:'applied'} ).data().sum();
        ...
        sumVigenteCXC = Math.round((table.cells(vigente, 4).data().sum() + Number.EPSILON) * 100) / 100;
        ...
        sumVencidoCXC = Math.round((table.cells(vencido, 4).data().sum() + Number.EPSILON) * 100) / 100;
        ...
        sumMoraCXC = Math.round((table.cells(mora, 4).data().sum() + Number.EPSILON) * 100) / 100;
